        ...
        return (
            <Container>
                <Segment style={{padding:'4em'}}>
                    <Header as='h4'>What is Covid 19 ?</Header>
                    ...
                    <Header as='h4'>What does Covid stand for ?</Header>
                    <p>
                    ...
                    <Header as='h4'>How dangerous is COVID-19 ?</Header>
                    ...
                    <Header as='h4'>How does the Virus spread ?</Header>
                    ...
                    <Header as='h4'>What are the symptoms of Covid 19 ?</Header>
                    ...
                    <strong> <em className='w3-large  '>Less common symptoms:</em></strong>
                    <List as='ol' style={{textTransform: 'capitalize'}}>
                    ...
                    <Header as='h4'>How long does it take for symptoms of the coronavirus
                        disease
                        to appear ?
                    </Header>
                    ...
                    <Header as='h4'>Is temperature screening effective to detect the
                        coronavirus
                        disease ?</Header>
                    ...
                    <Header as='h4'>What can I do to protect myself and others from
                        COVID-19 ?</Header>
                    <List as='ol' style={{textTransform: 'capitalize'}}>
                        <List.Item as='li'>
                    ...
                    <Header as='h4'>Is there a vaccine available ?</Header>
                    <p>At the moment there is no vaccine for COVID 19</p>
                    <Header as='h4'>How to keep Your Immunity strong ?</Header>
                    <List as='ol'>
