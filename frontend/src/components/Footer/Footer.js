...
import {Grid, Header, List, Segment, Icon, Button, Container} from "semantic-ui-react";
import {Link} from "react-router-dom";

const Footer = () => (
    <Fragment>
        <Segment inverted vertical style={{padding: '5em 0em', margin: ' 5em 0em 0em', backgroundColor: '#2cc72e'}}>
            <Container>
                <Grid divided inverted stackable='mobile' doubling='tablet' columns={4}>
                        <Grid.Column >
        ...
        <Segment attached inverted vertical style={{backgroundColor: '#0093dc'}} size='tiny'>
            <Grid columns={4} doubling='tablet' stackable='mobile' container>
                <Grid.Column>
